        ...
        expect = dict(
            ...
            positions = [
                ...
                dict(position='B4', unit_load_device='463L',
                     destination_icao='KNGU', weight='1635', weight_unit='LB',
                     building='C'),
                dict(position='B5', unit_load_device='463L',
                     destination_icao='KNGU', weight='1970', weight_unit='LB',
                     building='C'),
                dict(position='B6', unit_load_device='463L',
                     destination_icao='KNGU', weight='3115', weight_unit='LB',
                     building='C'),
                dict(position='B7', unit_load_device='463L',
                     destination_icao='KNGU', weight='3190', weight_unit='LB',
                     building='C'),
                dict(position='B8', unit_load_device='463L',
                     destination_icao='KNGU', weight='3485', weight_unit='LB',
                     building='C'),
