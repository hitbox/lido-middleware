...
class TestParse(unittest.TestCase):
    ...
    def test_parse_load_plan(self):
        ...
        expect = dict(
            ...
            positions = [
                dict(position='B1', unit_load_device=None, destination=None,
                     weight=None, weight_unit=None, building=None),
                dict(position='B2', unit_load_device=None, destination=None,
                     weight=None, weight_unit=None, building=None),
                dict(position='B3', unit_load_device=None, destination=None,
                     weight=None, weight_unit=None, building=None),
                ...
                dict(position='B8', unit_load_device='463L',
                     ...
                     building='C'),
                dict(position='B9', unit_load_device=None, destination=None,
                     weight=None, weight_unit=None, building=None),
                dict(position='B10', unit_load_device=None, destination=None,
                     weight=None, weight_unit=None, building=None),
                dict(position='PAX1', unit_load_device=None, destination=None,
                ...
                dict(position='2', unit_load_device='PAX BAGS',
                     ...
                     building='C'),
                dict(position='3', unit_load_device='FAK', destination=None,
                     weight='2249', weight_unit='LB', building='C'),
                dict(position='4', unit_load_device='FAK', destination=None,
        ...
        with open('tests/pistol_message.txt') as pistol_message_file:
            ...
            load_plan_data = parse.loadplan_from_text(text)
            self.assertDictEqual(load_plan_data, expect)
    ...
    def test_parse_position(self):
        ...
        self.assertDictEqual(parse._position('-A1.NIL'),
                             dict(position = 'A1',
                                  ...
                                  building = None))
        # normal expected
        self.assertDictEqual(parse._position('-A2L/AAA00000AA/BBB/200LB/A'),
                             dict(position = 'A2L',
