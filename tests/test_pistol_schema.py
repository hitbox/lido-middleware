    ...
    def test_loadplan_from_text(self):
        ...
        b = [
            dict(position='B1', unit_load_device=None, destination_icao=None,
                 destination_iata=None, weight=None, weight_unit=None,
                 building=None),
            ...
            dict(position='PAX1', unit_load_device=None, destination_icao=None,
                 destination_iata=None, weight=2400, weight_unit='LB',
                 building='C'),
            dict(position='1', unit_load_device='CREW BAGS',
                 destination_iata=None, destination_icao=None, weight=250,
                 weight_unit='LB',
                 building='C'),
            dict(position='2', unit_load_device='PAX BAGS',
                 destination_iata=None, destination_icao=None, weight=720,
                 weight_unit='LB',
                 building='C'),
            dict(position='3', unit_load_device='FAK', destination_icao=None,
                 destination_iata=None, weight=2249, weight_unit='LB',
                 building='C'),
            dict(position='4', unit_load_device='FAK', destination_icao=None,
                 destination_iata=None, weight=1372, weight_unit='LB',
                 building='C'),
        ]
